...
include $(BUILD_PREBUILT)
 ...
 include $(CLEAR_VARS)
LOCAL_MODULE := libaw_axxdec
LOCAL_SRC_FILES := lib32/$(MY_SDK)/libaw_axxdec.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libaw_dxxdec
LOCAL_SRC_FILES := lib32/$(MY_SDK)/libaw_dxxdec.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libaw_wmadec
LOCAL_SRC_FILES := lib32/$(MY_SDK)/libaw_wmadec.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libaxx
LOCAL_SRC_FILES := lib32/$(MY_SDK)/libaxx.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := libdxx
LOCAL_SRC_FILES := lib32/$(MY_SDK)/libdxx.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := librx
LOCAL_SRC_FILES := lib32/$(MY_SDK)/librx.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
...
include $(CLEAR_VARS)
LOCAL_MODULE := librv
LOCAL_SRC_FILES := lib32/$(MY_SDK)/librv.so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_SUFFIX := .so
LOCAL_MULTILIB := 32
