...
/*                {*/
                    ALOGV("%s %s device will be active", adev->dev_manager[0].name, "input");
                    adev->dev_manager[3].flag_in_active = 1;
...
/*                {*/
                    ALOGV("%s %s device will be active", adev->dev_manager[3].name, "output");
                    adev->dev_manager[3].flag_out_active = 1;
