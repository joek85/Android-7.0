...
#define SF_COMPRESSOR_MAXDELAY   300
...
typedef struct {
	...
	int delaywritepos;
	int delayreadpos;
	float delaybuf1[SF_COMPRESSOR_MAXDELAY]; // predelay buffer
	float delaybuf2[SF_COMPRESSOR_MAXDELAY]; // predelay buffer
